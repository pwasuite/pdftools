...
export const getPageCount = vi.fn(() => Promise.resolve({ pageCount: 5 }));

export const runGSOperation = vi.fn((operation, data) => Promise.resolve({ outputs: [] }));

export const _GSPS2PDF = vi.fn(() => Promise.resolve({ outputs: [] }));
