...
describe("MainPage", () => {
  ...
  describe("English", () => {
    ...
    it("renders tagline", () => {
      render(<MainPage {...defaultProps} />);
      expect(
        screen.getByText("Browser-based PDF tools powered by Ghostscript WASM")
      ).toBeInTheDocument();
    });
  ...
  describe("French", () => {
    ...
    it("renders tagline in French", () => {
      render(<MainPage {...frenchProps} />);
      expect(
        screen.getByText("Outils PDF dans le navigateur propulsés par Ghostscript WASM")
      ).toBeInTheDocument();
    });
    ...
    it("displays footer links in French", () => {
      render(<MainPage {...frenchProps} />);
      expect(
        screen.getByText("LICENCE, AUCUNE GARANTIE ET LIMITATION DE RESPONSABILITÉ")
      ).toBeInTheDocument();
